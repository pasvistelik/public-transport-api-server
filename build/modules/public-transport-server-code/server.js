...
var AppServer = function () {
    ...
    (0, _createClass3.default)(AppServer, null, [{
        ...
        value: function findWays(fromPositionStr, toPositionStr, myStartTimeStr, my_dopTimeMinutes, my_speed, typesStr) {
            ...
            return _regenerator2.default.async(function findWays$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            _context.prev = 4;
                            _context.next = 7;
                            return _regenerator2.default.awrap(getCountedWays(fromPositionStr, toPositionStr, myStartTimeStr, my_dopTimeMinutes, my_speed, typesStr));
...
function getCountedWays(fromPositionStr, toPositionStr, myStartTimeStr, my_dopTimeMinutes, my_speed, typesStr) {
    ...
    return _regenerator2.default.async(function getCountedWays$(_context2) {
        while (1) {
