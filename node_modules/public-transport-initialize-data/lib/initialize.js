...
function initialize(allStations, allRoutes, allTimetables) {
    ...
    for (var _i2 = 0, _n2 = allTimetables.length, timetable = allTimetables[0]; _i2 < _n2; timetable = allTimetables[++_i2]) {
        ...
        for (var kkk = 0, mnkk = timetable.table.length, t = timetable.table[0]; kkk < mnkk; t = timetable.table[++kkk]) {
            for (var iik = 0, mnii = t.times.length, st = t.times[0], stTime; iik < mnii - 1; st = t.times[++iik]) {
