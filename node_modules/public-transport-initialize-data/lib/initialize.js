...
function initialize(allStations, allRoutes, allTimetables) {
    ...
    for (var i = 0, n = allRoutes.length, currentRoute = allRoutes[0]; i < n; currentRoute = allRoutes[++i]) {
    ...
    for (var _i = 0, _n = allTimetables.length, timetable = allTimetables[0]; _i < _n; timetable = allTimetables[++_i]) {
